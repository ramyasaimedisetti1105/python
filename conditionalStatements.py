...
"""
nested if : A if with in a if is called nested if
syntax: if (condtion):
            outer if statements
            if (condition)
               inner if statements
...
"""
# program on weather advisories
is_snowing=True
temp= int(input("enter the temperature: "))
if is_snowing<10:
    print("please carry umbrella..")
    if is_snowing==-10:
        print("please carry jacket also with umbrella!..")
    else:
...
"""
Shorthand if: writing a if in a line is called shorthand if 
